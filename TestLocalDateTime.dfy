...
module TestLocalDateTime {
  ...
  method TestIsLeapYear() {
    assert LDT.IsLeapYear(2020); // Divisible by 4 and not by 100
    assert !LDT.IsLeapYear(2021); // Not divisible by 4
    assert !LDT.IsLeapYear(1900); // Divisible by 100 but not by 400
    assert LDT.IsLeapYear(2000); // Divisible by 400
  }
  ...
  method TestDaysInMonth() {
    assert LDT.DaysInMonth(2023, 1) == 31;
    assert LDT.DaysInMonth(2023, 2) == 28;
    assert LDT.DaysInMonth(2020, 2) == 29; // Leap year
    assert LDT.DaysInMonth(2023, 4) == 30;
    assert LDT.DaysInMonth(2023, 12) == 31;
  }

  method TestDaysInYear() {
    assert LDT.DaysInYear(2023) == 365;
    assert LDT.DaysInYear(2020) == 366; // Leap year
  }
}
