// Dafny program TestDuration.dfy compiled into C#
...
// Command-line arguments: run TestDuration.dfy
// TestDuration.dfy
...
// end of class FuncExtensions
namespace Std.DateTime.Duration {

  public partial class __default {
    public static bool IsValid(Std.DateTime.Duration._IDuration d) {
      return ((((d).dtor_seconds).Sign != -1) && (((d).dtor_seconds) < (Std.DateTime.Duration.__default.SECONDS__PER__MINUTE))) && ((((d).dtor_millis).Sign != -1) && (((d).dtor_millis) < (Std.DateTime.Duration.__default.MILLISECONDS__PER__SECOND)));
    }
    public static BigInteger ToTotalMilliseconds(Std.DateTime.Duration._IDuration d) {
      return (((d).dtor_seconds) * (Std.DateTime.Duration.__default.MILLIS__PER__SECOND)) + ((d).dtor_millis);
    }
    public static Std.DateTime.Duration._IDuration FromMilliseconds(BigInteger ms) {
      BigInteger _0_seconds = Dafny.Helpers.EuclideanDivision(ms, Std.DateTime.Duration.__default.MILLIS__PER__SECOND);
      BigInteger _1_milliseconds = Dafny.Helpers.EuclideanModulus(ms, Std.DateTime.Duration.__default.MILLIS__PER__SECOND);
      return Std.DateTime.Duration.Duration.create(_0_seconds, _1_milliseconds);
    }
    public static bool Equal(Std.DateTime.Duration._IDuration d1, Std.DateTime.Duration._IDuration d2)
    {
      return (Std.DateTime.Duration.__default.ToTotalMilliseconds(d1)) == (Std.DateTime.Duration.__default.ToTotalMilliseconds(d2));
    }
    public static BigInteger Compare(Std.DateTime.Duration._IDuration d1, Std.DateTime.Duration._IDuration d2)
    {
      if ((Std.DateTime.Duration.__default.ToTotalMilliseconds(d1)) < (Std.DateTime.Duration.__default.ToTotalMilliseconds(d2))) {
        return new BigInteger(-1);
      } else if ((Std.DateTime.Duration.__default.ToTotalMilliseconds(d1)) > (Std.DateTime.Duration.__default.ToTotalMilliseconds(d2))) {
        return BigInteger.One;
      } else {
        return BigInteger.Zero;
      }
    }
    public static Std.DateTime.Duration._IDuration Plus(Std.DateTime.Duration._IDuration d1, Std.DateTime.Duration._IDuration d2)
    {
      return Std.DateTime.Duration.__default.FromMilliseconds((Std.DateTime.Duration.__default.ToTotalMilliseconds(d1)) + (Std.DateTime.Duration.__default.ToTotalMilliseconds(d2)));
    }
    public static Std.DateTime.Duration._IDuration Minus(Std.DateTime.Duration._IDuration d1, Std.DateTime.Duration._IDuration d2)
    {
      return Std.DateTime.Duration.__default.FromMilliseconds((Std.DateTime.Duration.__default.ToTotalMilliseconds(d1)) - (Std.DateTime.Duration.__default.ToTotalMilliseconds(d2)));
    }
    public static BigInteger GetSeconds(Std.DateTime.Duration._IDuration d) {
      return (d).dtor_seconds;
    }
    public static BigInteger GetMilliseconds(Std.DateTime.Duration._IDuration d) {
      return (d).dtor_millis;
    }
    public static BigInteger MILLIS__PER__SECOND { get {
      return new BigInteger(1000);
    } }
    public static BigInteger MILLIS__PER__MINUTE { get {
      return (new BigInteger(60)) * (Std.DateTime.Duration.__default.MILLIS__PER__SECOND);
    } }
    public static BigInteger MILLIS__PER__HOUR { get {
      return (new BigInteger(60)) * (Std.DateTime.Duration.__default.MILLIS__PER__MINUTE);
    } }
    public static BigInteger MILLIS__PER__DAY { get {
      return (new BigInteger(24)) * (Std.DateTime.Duration.__default.MILLIS__PER__HOUR);
    } }
    public static BigInteger SECONDS__PER__MINUTE { get {
      return new BigInteger(60);
    } }
    public static BigInteger MILLISECONDS__PER__SECOND { get {
      return new BigInteger(1000);
    } }
    public static BigInteger MINUTES__PER__HOUR { get {
      return new BigInteger(60);
    } }
    public static BigInteger HOURS__PER__DAY { get {
      return new BigInteger(24);
    } }
  }

  public interface _IDuration {
    bool is_Duration { get; }
    BigInteger dtor_seconds { get; }
    BigInteger dtor_millis { get; }
    _IDuration DowncastClone();
  }
  public class Duration : _IDuration {
    public readonly BigInteger _seconds;
    public readonly BigInteger _millis;
    public Duration(BigInteger seconds, BigInteger millis) {
      this._seconds = seconds;
      this._millis = millis;
    }
    public _IDuration DowncastClone() {
      if (this is _IDuration dt) { return dt; }
      return new Duration(_seconds, _millis);
    }
    public override bool Equals(object other) {
      var oth = other as Std.DateTime.Duration.Duration;
      return oth != null && this._seconds == oth._seconds && this._millis == oth._millis;
    }
    public override int GetHashCode() {
      ulong hash = 5381;
      hash = ((hash << 5) + hash) + 0;
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._seconds));
      hash = ((hash << 5) + hash) + ((ulong)Dafny.Helpers.GetHashCode(this._millis));
      return (int) hash;
    }
    public override string ToString() {
      string s = "Duration.Duration.Duration";
      s += "(";
      s += Dafny.Helpers.ToString(this._seconds);
      s += ", ";
      s += Dafny.Helpers.ToString(this._millis);
      s += ")";
      return s;
    }
    private static readonly Std.DateTime.Duration._IDuration theDefault = create(BigInteger.Zero, BigInteger.Zero);
    public static Std.DateTime.Duration._IDuration Default() {
      return theDefault;
    }
    private static readonly Dafny.TypeDescriptor<Std.DateTime.Duration._IDuration> _TYPE = new Dafny.TypeDescriptor<Std.DateTime.Duration._IDuration>(Std.DateTime.Duration.Duration.Default());
    public static Dafny.TypeDescriptor<Std.DateTime.Duration._IDuration> _TypeDescriptor() {
      return _TYPE;
    }
    public static _IDuration create(BigInteger seconds, BigInteger millis) {
      return new Duration(seconds, millis);
    }
    public static _IDuration create_Duration(BigInteger seconds, BigInteger millis) {
      return create(seconds, millis);
    }
    public bool is_Duration { get { return true; } }
    public BigInteger dtor_seconds {
      get {
        return this._seconds;
      }
    }
    public BigInteger dtor_millis {
      get {
        return this._millis;
      }
    }
  }
} // end of namespace Std.DateTime.Duration
namespace TestDuration {

  public partial class __default {
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      Std.DateTime.Duration._IDuration _0_d1;
      _0_d1 = Std.DateTime.Duration.Duration.create(new BigInteger(10), new BigInteger(500));
      Std.DateTime.Duration._IDuration _1_d2;
      _1_d2 = Std.DateTime.Duration.Duration.create(new BigInteger(5), new BigInteger(250));
      BigInteger _2_total1;
      _2_total1 = Std.DateTime.Duration.__default.ToTotalMilliseconds(_0_d1);
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("d1 total ms: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_2_total1));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Std.DateTime.Duration._IDuration _3_d3;
      _3_d3 = Std.DateTime.Duration.__default.Plus(_0_d1, _1_d2);
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("d1 + d2 = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_3_d3));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Std.DateTime.Duration._IDuration _4_d4;
      _4_d4 = Std.DateTime.Duration.__default.Minus(_0_d1, _1_d2);
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("d1 - d2 = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_4_d4));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      BigInteger _5_cmp;
      _5_cmp = Std.DateTime.Duration.__default.Compare(_0_d1, _1_d2);
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("compare(d1,d2) = ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_5_cmp));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
  }
} // end of namespace TestDuration
namespace _module {

} // end of namespace _module
class __CallToMain {
  public static void Main(string[] args) {
    Dafny.Helpers.WithHaltHandling(() => TestDuration.__default._Main(Dafny.Sequence<Dafny.ISequence<Dafny.Rune>>.UnicodeFromMainArguments(args)));
  }
}
